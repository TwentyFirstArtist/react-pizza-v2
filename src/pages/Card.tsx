...
import { cardSelector, clearCard } from '../redux/slicers/cardSlice';
...
const Card: React.FC = () => {
    ...
    const { item, totalPrice } = useSelector(cardSelector)
        ...
        <div className="container container--cart">
            <div className="cart">
                ...
                <div className="content__items--card">
                    {
                        item.map((obj: ItemMap) => (
                            <CardItem key={obj.cardId} {...obj} />
                        ))
                    }
                </div>
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всього піцц: <>
                            {
                                item.reduce((sum: number, obj: { count: number }) => obj.count + sum, 0)
                            }
                            шт.</>
                        </span>
